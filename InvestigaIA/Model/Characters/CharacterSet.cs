    ...
    public static class CharacterSet
    {
        ...
        public static List<Suspect> suspects = new()
        {
            ...
            new Suspect(name: "Artyom Dragovich" ,
                ...
                personality: "Preciso, meticuloso e amargamente inteligente. Mantém um registro de dívidas — não monetárias, mas morais. Ajuda Viktor com informações, sempre por um preço que não se mede em dinheiro.",
                imageCode: "male3"){Id =  3.ToString()},
             new Suspect(name: "Mila Redcat",
                 ...
                 personality: "Rebelde, sarcástica, vive rápido para não pensar. Suas mãos estão sempre sujas de graxa, seu coração atrás de muros.",
                 imageCode: "female3") { Id = 8.ToString() },
              new Suspect(name: "Sofia Darkwood" ,
                  ...
                  personality: "Carismática, quebrada, magnética. Vaga de bar em bar, buscando sentido na fumaça e na bebida barata. Viktor já a salvou de si mesma — ela ainda não decidiu se o perdoa por isso.",
                  imageCode: "female2") { Id = 6.ToString() },
               new Suspect(name: "Katarina Darkwood",
                   ...
                   personality: "Desafiante, idealista, queima com juventude mas fala como alguém duas vezes mais velha." ,
                   imageCode:"male4" ) { Id = 4.ToString() },
                new Suspect(name: "Michael Bronson" ,
                    ...
                    personality: "Brutalmente honesto, mas leal à sua maneira distorcida. Enxerga a luta como confissão — dor como absolvição.",
                    imageCode: "female4") { Id = 9.ToString() },
                 new Suspect(name:"Ludmila Blackwood" ,
                     ...
                     personality: "Elegante, implacável e amargamente charmosa. Manipula pessoas como peças de xadrez.",
                     imageCode: "female1") { Id = 5.ToString() },
                  new Suspect(name: "Anton Petro" ,
                      ...
                      personality:"Nervoso, falante, brilhante em curtos períodos. Paranoico.",
                      imageCode: "male2" ) { Id = 2.ToString() },
